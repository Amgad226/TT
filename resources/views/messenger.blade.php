...
<body>
    ...
    <!-- secondery loader -->
    <div class="send-image-loader lds-ripple "
        style="display:none;  top: 40%;  right: 35%;  z-index: 100000;  position: absolute;">
        <div></div>
        <div></div>
    </div>
    ...
    <div class="popup d-none "
        ...
        <div style="display: flex; flex-direction: row ;justify-content: space-between">
            ...
            <p
                style="font-size:28px;height:30px;width: calc(100% /2);margin-left:90px;margin-top:20px; background-color:">
                edit profile </p>
            <div style="height:22px;width: calc(100% /15);background-color:#a70604; position:;left:90%;top:2%"
                onclick="{popupFun()}" class=" icon icon-xl   exit">
        ...
        <div style="display: flex; flex-direction: column ;justify-content: space-between;margin-bottom:40px ">
            <div style="height:100/2%; margin: 10px;  width:320px;">
                <span>new name</span>
                <input style="color:var(--arrow);height:100/2%; text-align:center;width:330px;"
                    class=" input-group-text new_name username" name="new_name" type="text"
            ...
            <div style="height:100/2%; margin: 10px;  width:320px;">
                ...
                <input style="color:var(--arrow);height:100/2%; text-align:center;width:330px;"
                    class=" input-group-text new_name username" name="new_name" type="text"
                    value="09154891589  {{ Auth::user()->phone }}">
            </div>
            {{-- <br> --}}
            <div style="height:100/2% ;margin: 10px;width:320px">
                <span style="padding-right:10px; ">new img</span>
                <input id="upload-profile-photo"
                    style="height:100/2%; color:var(--arrow);text-align:center;margin-left:0%"
                    class=" input-group-text new_img " name="new_img" type="file" value=".">
            </div>

        </div>
        <div style="color:var(--arrow);width:330px;margin-bottom:5px" onclick="{fetchUpdateName();}"
            class="icon icon-xl  btn  btn btn-secondary">
            send
        </div>
    ...
    <div class="layout overflow-hidden ">
        ...
        <nav class=" navigation d-flex flex-column text-center navbar navbar-light hide-scrollbar">
            ...
            <a href="#" title="TT" class="d-none d-xl-block mb-6  welcome-text to-return-home"
                onclick="{
            ...
            <!-- Nav items -->
            <ul class="  security-chats d-flex nav navbar-nav flex-row flex-xl-column flex-grow-1 justify-content-between justify-content-xl-center align-items-center w-100 py-4 py-lg-2 px-lg-3"
                role="tablist">
                ...
                <!-- New chat -->
                <li class="nav-item ">
                    <a class="nav-link py-0 py-lg-8 tap-friend-group" id="tab-create-chat"
                        href="#tab-content-create-chat" title="Create group" data-bs-toggle="tab" role="tab">
                        <div class="icon icon-xl ">
                ...
                <!-- All Users -->
                <li class="nav-item">
                    <a class="nav-link py-0 py-lg-8" id="tab-all-users" href="#tap-content-all-users"
                ...
                <li class="nav-item">
                    <a class="nav-link py-0 py-lg-8" id="tab-friends" href="#tab-content-friends"
                        title="{{ __('Friends') }}" data-bs-toggle="tab" role="tab">
                        <div class="icon icon-xl">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                ...
                <li class="nav-item d-  d-xl-block ">
                    <a class="nav-link py-0 py-lg-8" id="tab-support" href="#tab-content-support" title="Support"
                        data-bs-toggle="tab" role="tab">
                        <div class="icon icon-xl">
                            <svg style="cursor: pointer;"class="toggel" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 96 96">
                                <switch>
                ...
                <li class="nav-item ">
                    <a href="#" class="nav-link p-0 mt-lg-2" data-bs-toggle="modal"
                        ...
                        <div class="avatar avatar-online mx-auto d- d-xl-block">
                            <div class="avatar ">
                                <img class="avatar-img update-profile-img" src="{{ asset(Auth::user()->img) }}"
                                    alt="">
                            </div>
                        </div>
                    </a>
                                ...
                                <div class="tab-content" role="tablist">
                                    <div class="tab-pane fade show active" id="create-chat-info" role="tabpanel">
                                        ...
                                        <div class="card border-0">
                                            ...
                                            <div class="card-body">
                                                <form id="groupForm" autocomplete="off">
                                                    <div class="profile">
                                                        <div class="profile-img text-primary rounded-top">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                fill="currentColor" viewBox="0 0 400 140.74">
                                                                <defs>
                                                                    <style>
                                                                        .cls-2 {
                                                                            fill: #fff;
                                                        ...
                                                        <div class="profile-body p-0">
                                                            <div class="avatar avatar-lg">
                                                                <span
                                                                    class="avatar-text bg-primary add-group-img span-icon-group">
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        width="24" height="24"
                                                                ...
                                                                <img style="display: none" class="avatar-img"
                                                                    src="" alt="" id="blah">
                                                                ...
                                                                <input name="img"id="upload-chat-img"
                                                                    class="d-none imgGroup " type="file">
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-floating">
                                                                ...
                                                                <input
                                                                    ...
                                                                    class="form-control groupName" id="floatingInput "
                                                                    placeholder="{{ __('Enter a chat name') }}">
                                                            </div>
                                                        </div>
                                                        {{-- <br><br> --}}
                                                        <div class="col-12">
                                                            <div class="form-floating">
                                                                ...
                                                                <textarea name='groupDescription' class="form-control groupDescription" placeholder="{{ __('Description') }}"
                                                                    id="floatingTextarea groupDescription" rows="8" data-autosize="true" style="min-height: 100px;"></textarea>
                                                    ...
                                                    <br>
                                                    {{-- <input type="submit" /> --}}
                                                    <div class="container mt-n4 mb-8 position-relative button-create-group"
                                                        style="display:none">
                                                        <button
                                                ...
                                                <div class="container mt-n4 mb-8 position-relative ">
                                                    ...
                                                    <button
                                                        class="btn btn-lg btn-danger w-100 d-flex align-items-center if-arrayGroup"
                                                        style="">{{ __('no selected members yet') }}</button>
                                                </div>
                                        ...
                                        <div class="d-flex align-items-center mt-4 px-6">
                                            <small
                                                class="text-muted me-auto">{{ __('Enter chat name and add photo.') }}</small>
                                        </div>
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="hide-scrollbar">
                            ...
                            <div class="container py-8">
                                ...
                                <div class="mb-6">
                                    <div class="mb-5">
                                        <form id="form-search-users" action="{{ route('search.users') }}"
                                            method="POST">
                                            <div class="input-group">
                                                ...
                                                <input id="input-search-users"scrept name="name" type="text"
                    ...
                    <div class="d-flex flex-column h-100">
                        <div class="hide-scrollbar">
                            <div class="container py-8">
                                ...
                                <div class="mb-6">
                                    {{-- {{route('search.users')}} --}}
                                    <form id = "search_friends" action="{{ route('search.friends') }}"
                                        method="POST">
                                        @csrf
                                        <div class="input-group">
                                            <div class="input-group-text">
                                            ...
                                            <input id= "input-search-friends"name="name" type="text"
                                                class="form-control form-control-lg ps-0"
                                                placeholder="{{ __('Search friend') }}"
                                                aria-label="Search for messages or users...">
                                        </div>
                                    </form>
                                ...
                                <div class="card border-0">
                                    <div class="card-body">
                                        <div class="row align-items-center gx-5">
                                            <div class="col-auto">
                                                <div class="avatar">
                                                    <img data-action='zoom' src="{{ Auth::user()->img }}"
                                                        alt="#" class="avatar-img update-profile-img">
                                            ...
                                            <div class="col-auto">
                                                <form action="/logout" method="post">
                                                    ...
                                                    <div class="icon">
                                                        ...
                                                        <button style="padding: 2px 10px;" type="submit"
                                                            ...
                                                            <form id = 'change_pass'
                                                                ...
                                                                <div class="form-floating mb-6">
                                                                    <input name='current_password' type="password"
                                                                        ...
                                                                        autocomplete="">
                                                                    <label
                                                                        for="profile-current-password">{{ __('Current password') }}</label>
                                                                </div>
                                                                ...
                                                                <div class="form-floating mb-6">
                                                                    <input name='new_password'type="password"
                                                                        ...
                                                                        autocomplete="">
                                                                    <label
                                                                        for="profile-new-password">{{ __('New password') }}</label>
                                                                </div>
                                                                ...
                                                                <div class="form-floating mb-6">
                                                                    <input name='verify_password'type="password"
                                                                        ...
                                                                        autocomplete="">
                                                                    <label
                                                                        for="profile-verify-password">{{ __('Verify password') }}</label>
                                                                    <input class="" type="checkbox"
                                                                        onclick="showHidePassword()">{{ __('Show password') }}

                                                                </div>
                                                                <button type="submit"
                                                                    class="btn btn-block btn-lg btn-primary w-100">{{ __('Save') }}</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="accordion-item">
                                                    <div class="custom-select">
                                                        ...
                                                        <form action="{{ URL::current() }}" method="get">
                                                            <select style="" class="lang" name="local"
                                    ...
                                    <div class="card border-0">
                                        <div class="card-body py-2">
                                            ...
                                            @if (auth()->user()->deviceToken == null)
                                                you can enable extirnal notifcation and get notifications when you have
                                                new messages
                                                <br>
                                                <button id="checkNoti"class="btn btn-block w-100 btn-dark"
        ...
        <main class="main is-visible" data-dropzone-area="">
            ...
            <div class="container h-100">
                ...
                <div class="col-2 d-xl-none welcome-text"
                    style=" left:5%; top:4%; z-index: 1; position: absolute;  z-index: 1; width:50%; width:50%;">
                    <a class="icon icon-lg text-muted" href="#" data-toggle-chat="">
                        <svg fill="var(--arrow)" width="50px" height="50px" viewBox="0 0 50 50"
                            ...
                            <path fill="var(--arrow)" d="M25.3 34.7L15.6 25l9.7-9.7 1.4 1.4-8.3 8.3 8.3 8.3z" />
                            <path fill="var(--arrow)" d="M17 24h17v2H17z" />
                        </svg>
                    </a>
                </div>
                ...
                <div class="d-flex flex-column h-100 position-relative">
                        ...
                        <div class="chat-header border-bottom py-4 py-lg-7">
                            <div class="row align-items-center">
                                ...
                                <div class="col-2 d-xl-none app-bar-name-and-img" style="display: none;">
                                    <a class="icon icon-lg text-muted" href="#" data-toggle-chat="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" color="var(--arrow)" stroke="currentColor"
                                ...
                                <div class="col-8 col-xl-12">
                                    <div class="row align-items-center text-center text-xl-start">
                                        ...
                                        <div class="col-12 col-xl-6">
                                            <div class="row align-items-center gx-5">
                                                <div class="col-auto"
                                                    style="display: flex; flex-direction: row;justify-content: space-around;margin-left: 50px; ">
                                                    <div class="avatar avatar-online d- d-xl-inline-block">
                                                        <img class="avatar-img" id='chat-img' src=""
                                                            alt="">
                                                    </div>
                                                    <div class="col overflow-hidden">
                                                        <h5 class="text-truncate" id="chat-name"
                                                            style="font-size: 25px;"> </h5>
                                                        <p style="display:inline  z-index: 100000;  position: absolute;"
                                                            id="is-typing"class="text-truncate d-none">
                                                            {{ __('is typing') }}<span
                    ...
                    <div class="form-ccontainer chat-body hide-scrollbar flex-1 h-100" style="display:none;">
                        ...
                        <div class="chat-body-inner" style="padding-bottom:0px; margin:110px;">
                            ...
                            <div id="messages_container" class=" py-6 my-lg-12 " style="padding:0px ; background:"
                                id="chat-body">
                                <!-- Message -->
                    ...
                    <div class="footer-input-chat" style="display:none; ">
                        <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                            ...
                            <!-- Chat: Form -->
                            <form style="top: 20px; z-index: 200000;  ; " id="targetttt"
                                class=" chat-form rounded-pill bg-dark" data-emoji-form="" method= "post"
                                action="{{ route('api.message.store') }}">
                                @csrf
                                ...
                                <div class="row align-items-center gx-0">
                                    ...
                                    <div class="col-auto">
                                        <a href="#"onclick="selectFile()"
                                            class="btn btn-icon btn-link text-body "id="">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                                class="feather feather-paperclip">
                                    ...
                                    <div class="col-auto">
                                        <a href="#"onclick="inputImageMessage()"
                                            class="btn btn-icon btn-link text-body " id="">
                                            <svg aria-hidden="true" focusable="false" data-prefix="fas"
                                                data-icon="images" class="svg-inline--fa fa-images " role="img"
                                    ...
                                    <div class="col">
                                        <div class="input-group">
                                            <input name ="body"
                                                class="input-have-message form-control px-0"onkeyup="countChar(this)"
                                                placeholder="{{ __('Type your message...') }}" rows="1"
                                                data-emoji-input="" data-autosize="true" autocomplete="off">

                                            <a href="#" class="input-group-text text-body pe-0">
                                                <div class="holder">
                                                    <div data-role="controls">
                                                        <button class=" ss" type="button"
                                                            style=";padding: 0px px;background-color:transparent   ; border: 0px solid #900; border-radius:20px"
                                                            onclick="{return false; }">
                                                            <span class="icon icon-lg">
                                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                                    viewBox="0 0 100 100">
                                                                    <path fill="var(--bs-body-color)"
                                                                        d="M36 57V23c0-7.7 6.3-14 14-14s14 6.3 14 14v34c0 7.7-6.3 14-14 14s-14-6.3-14-14zm42 0c0-1.1-.9-2-2-2s-2 .9-2 2c0 13.2-10.8 24-24 24S26 70.2 26 57c0-1.1-.9-2-2-2s-2 .9-2 2c0 14.8 11.5 26.9 26 27.9V91h-7c-1.1 0-2 .9-2 2s.9 2 2 2h18c1.1 0 2-.9 2-2s-.9-2-2-2h-7v-6.1c14.5-1 26-13.1 26-27.9z" />
                                                                </svg>
                                                            </span>
                                                        </button>
                                            ...
                                            <a href="#" class="input-group-text text-body pe-0"
                                                style="margin: 1; padding:5px" data-emoji-btn="">
                                                <span class="icon icon-lg">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                        height="24" viewBox="0 0 24 24" fill="none"
                                                        stroke="currentColor" stroke-width="2" stroke-linecap="round"
        ...
        <div class="group-description  offcanvas offcanvas-end offcanvas-aside" data-bs-scroll="true"
            data-bs-backdrop="false" tabindex="-1" id="offcanvas-more-group">
                ...
                <div class="text-center py-10">
                    <div class="row gy-6">
                        ...
                        <div class="col-11">
                            ...
                            <p class="group-description-description"> Bootstrap is an open source <br> toolkit for
                                developing web with <br> HTML, CSS, and JS.</p>
                        </div>
                    </div>
                </div>
                <!-- Avatar -->
                        ...
                        <div class="row row-cols-3 g-3 py-6">
                            <div class="col">
                                <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview">
                                    <img class="img-fluid rounded update-profile-img "
                                        data-action="zoom"src="{{ Auth::user()->img }}" alt="">
                                </a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-fullscreen-xl-down">
            <div class="modal-content">
                ...
                <div class="modal-body py-0">
                            ...
                            <div style="">
                                ...
                                <div class="btn btn-sm btn-icon btn-dark"
                                  ...
                                  pop=true;
                                    ...
                                    {{-- edit --}}
                                    <svg fill="white" height="50" viewBox="0 0 20 20" width="50"
                                        id="cds-4">
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <p href="#tab-settings" title="{{ __('Settings') }}" data-bs-dismiss="modal">
                                {{ __('Settings') }}</p>
                        </li>
                        ...
                        <li class="list-group-item">
                            <form action="{{ route('logout') }}" method="post">
                                ...
                                <input type="submit" value="{{ __('Logout') }}"
                                    class="text-danger"style=" background-color: transparent !important ; border:solid 0px #3e444f;">
                            </form>
                        </li>
                    </ul>
                    <!-- List -->
    ...
    <script>
        // FIXME
        const tokenn = "{{ Request::cookie('token') }}" != "" ? "{{ Request::cookie('token') }}" :
            "{{ auth()->user()->createToken('MyToken')->plainTextToken }}"
        // alert(tokenn)
        const userId = {{ Auth::id() }}
        const userimg = "{{ Auth::user()->img }}";
        const username = "{{ Auth::user()->name }}";
        const stringHi = "{{ __('Hi') }}";
        const stringAdd = "{{ __('Add') }}";
        const stringHide = "{{ __('Hide') }}";
        const stringConfirm = "{{ __('Confirm') }}";
        const DeleteForAll = "{{ __('Delete for all') }}";
    ...
    <script>
        ...
        const Typing = (boolean) => {
            ...
            console.log("listening-on-typing-form-conversation-", response_conversation_id)
            channel.whisper(`listening-on-typing-form-conversation-${response_conversation_id}`, {
                user_id: userId,
        ...
        var u = 0;
        let currentListener = null; // To keep track of the current listener

        Object.defineProperty(this, 'response_conversation_id', {
            get: function() {
                return u;
            },
            set: function(newConversationId) {
                u = newConversationId;

                // Hide typing indicator when switching conversations
                $('#is-typing').addClass('d-none');
                console.log('Value changed! New Conversation: ' + newConversationId);

                // Unbind the old listener if it exists
                if (currentListener) {
                    Echo.private('chat')
                        .stopListening(`listening-on-typing-form-conversation-${currentListener}`);
                    console.log(`Stopped listening on conversation: ${currentListener}`);
                }

                // Bind to the new conversation
                currentListener = newConversationId;
                Echo.private('chat')
                    .listenForWhisper(`listening-on-typing-form-conversation-${newConversationId}`, (e) => {
                        console.log(`listenForWhisper: typing:${e.typing}`);
                        if (e.typing) {
                ...
                console.log(`Listening on new conversation: ${newConversationId}`);
            }
        });
    </script>
