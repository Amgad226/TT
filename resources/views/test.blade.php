...
.visitor{
    ...
    z-index:10000;
    /* Fallback color */background-color: rgba(0,0,0, 0.8);
    /* Black w/opacity/see-through */color: white;
    font-weight: bold;
   ...
   // z-index:0;
    ...
    <div class="visitor">this is visitor mode, login for real comversations  </div>
    ...
    <body>
               ...
               <hr>
                   <div style="display: flex; flex-direction: column ;justify-content: space-between;margin-bottom:40px " >
                       <div style="height:100/2%; margin: 10px;  width:320px;">
                          <span>new name</span>
                          <input style="color:var(--arrow);height:100/2%; text-align:center;width:330px;" class=" input-group-text new_name username" name="new_name" type="text" value="name">
                       </div>
                       <div style="height:100/2%; margin: 10px;  width:320px;">
                           <span>new phone</span>
                           <input style="color:var(--arrow);height:100/2%; text-align:center;width:330px;" class=" input-group-text new_name username" name="new_name" type="text" value="09154891589  ">
                        </div>
                   {{-- <br> --}}
                       <div style="height:100/2% ;margin: 10px;width:320px">
                    ...
                    <li class="nav-item " >
                        <a href="#" class="nav-link p-0 mt-lg-2" data-bs-toggle="modal" data-bs-target="#modal-profile">
                            <div class="avatar avatar-online mx-auto d- d-xl-block">
                                <div class="avatar ">
                                    <img class="avatar-img update-profile-img" src="{{ asset('img/logo.png') }}" alt="">
                                </div>
                            </div>
                        </a>
                    </li>
            ...
            <aside class="sidebar bg-light">
                ...
                <div class="col-2 d-xl-none welcome-text to-return-home" style="left: 90%; top:4%;   z-index: 1;  position: absolute;">
                    <a class="icon icon-lg text-muted" href="#" data-toggle-chat="">
                        <svg  width="24 " height="24 " viewBox="0 0 24 24" id="_24x24_On_Light_Arrow-Right" data-name="24x24/On Light/Arrow-Right" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="hide-scrollbar">
                                ...
                                <div class="container py-8">
                                    ...
                                    <div class="mb-6">
                                        <div class="mb-5">
                                            <form  id="form-search-users" action="#" method="POST" >
                                    ...
                                    <div class="card border-0">
                                        <div class="card-body">
                                            <div class="row align-items-center gx-5">
                                                <div class="col-auto">
                                                    <div class="avatar">
                                                        <img  data-action='zoom' src="{{ asset('img/logo.png') }}" alt="#" class="avatar-img update-profile-img">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    {{-- <a type="submit" href="/api/logout" class="text-muted"> --}}
                                                        ...
                                                        <div  class="icon">
                                                            ...
                                                            <button onclick="{
                                                                window.location.replace('{{route('tt')}}');
                                                            }" style="padding: 2px 10px;" type="submit" class="btn btn-primary">
                                                    ...
                                                    <div class="accordion-item">
                                                        ...
                                                        <div id="accordion-security-body-1" class="accordion-collapse collapse" aria-labelledby="accordion-security-1" data-parent="#accordion-security">
                                                            <div class="accordion-body">
                                                                {{-- <form id = 'change_pass' action="#" method="POST" autocomplete="on">
                                                                    @csrf --}}
                ...
                <div class="container h-100" >
                    ...
                    <!-- Mobile: close -->
                        ...
                        <div class="col-2 d-xl-none welcome-text" style=" left:5%; top:4%; z-index: 1; position: absolute;  z-index: 1; width:50%; width:50%;">
                            <a class="  text-muted" href="#" data-toggle-chat="">
                                <svg fill="var(--arrow)"   xmlns="http://www.w3.org/2000/svg"> 
                    ...
                    <div class="form-ccontainer chat-body hide-scrollbar flex-1 h-100" style="display:none;">
                     ...
                     <div class="footer-input-chat" style="display:none; " >
                        <div class="chat-footer pb-3 pb-lg-7 position-absolute bottom-0 start-0">
                            ...
                            <!-- Chat: Form -->
                            <form  style="top: 20px; z-index: 200000;  ; " id="targetttt" class=" chat-form rounded-pill bg-dark" data-emoji-form="" method= "post" action="#">
                               @csrf
                               ...
                               <input id ="" type="hidden" name= "type" value="text">
                                <div class="row align-items-center gx-0">
                                    ...
                                    <div class="col">
                                        <div class="input-group">
                                            <input name ="body" class="input-have-message form-control px-0"  onkeyup=""  placeholder="{{__('Type your message...')}}" rows="1" data-emoji-input="" data-autosize="true" autocomplete="off">
                    ...
                    <div class="row row-cols-3 g-3 py-6">
                        <div class="col">
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#modal-media-preview" >
                                <img class="img-fluid rounded update-profile-img " data-action="zoom" src="{{ asset('img/logo.png') }}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body py-0"  >
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">
                          ...
                          <a  href="{{route('tt')}}" class="text-danger"style=" background-color: transparent !important ; border:solid 0px #3e444f;">home</a>
                        </li>
        ...
        <script src="{{ asset ('assets/js/visitor/visitor-record.js')}}" ></script>
        <script src="{{ asset ('assets/js/visitor/visitor-markjivo.recorder.js')}}" ></script>
        <script src ="{{ asset('assets/js/visitor/visitor.js')}}"></script>
